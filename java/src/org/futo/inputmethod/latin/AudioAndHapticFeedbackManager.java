...
public final class AudioAndHapticFeedbackManager {
    ...
    public void performHapticFeedback(final View viewToPerformHapticFeedbackOn, final boolean repeatKey) {
        ...
        if (mSettingsValues.mKeypressVibrationDuration >= 0) {
            long duration = mSettingsValues.mKeypressVibrationDuration / (repeatKey ? 2 : 1);
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O && mVibrator != null) {
                mVibrator.vibrate(android.os.VibrationEffect.createOneShot(duration, android.os.VibrationEffect.DEFAULT_AMPLITUDE));
            } else {
                vibrate(duration);
            }
            return;
